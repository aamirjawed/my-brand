...
export default function Stats() {
  const stats = [
    { value: 450, suffix: "+", label: "Venues Audited", caption: "physically survey spatial clearances" },
    { value: 20, suffix: "+", label: "Regional Hubs", caption: "direct scouting access agreements" },
    { value: 30, suffix: "%", label: "Average Cost Savings", caption: "minimized food & beverage minimums" },
    { value: 100, suffix: "%", label: "Zoning Clearance", caption: "zero rigging or licensing permit issues" }
  ];
      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        <div className="flex items-center justify-center mb-14">
          <div className="flex items-center gap-3">
            ...
            <span className="text-orange-500 font-extrabold text-xs tracking-[0.3em] uppercase">Sourcing Performance</span>
            <div className="h-px w-12 bg-orange-600"></div>
          </div>
        </div>
