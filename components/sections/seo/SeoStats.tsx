...
export default function SeoStats() {
  const stats = [
    { value: 312, suffix: "%", label: "Avg. Organic Traffic Lift", caption: "within 6 months across all clients" },
    { value: 94, suffix: "%", label: "First Page Rankings", caption: "of target keywords ranked page 1" },
    { value: 500, suffix: "+", label: "Websites Optimized", caption: "across every major industry vertical" },
    { value: 8, suffix: "x", label: "ROI on SEO Investment", caption: "vs. equivalent paid ad spend budgets" },
  ];
