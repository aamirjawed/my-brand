...
export default function BrandingStats() {
  const stats = [
    { value: 700, suffix: "+", label: "Brand Identities Delivered", caption: "across startups, SMEs & enterprises" },
    { value: 94, suffix: "%", label: "Client Retention Rate", caption: "brands return for ongoing identity work" },
    { value: 3, suffix: "x", label: "Revenue Lift After Rebrand", caption: "avg. client growth post brand launch" },
    { value: 48, suffix: "hr", label: "Concept Delivery Time", caption: "first logo drafts in under 48 hours" },
  ];
