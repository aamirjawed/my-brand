  ...
  const steps = [
    {
      ...
      description: "We start by understanding the 'why' behind your event. Is it to reward top performers, launch a new product, or train executives? We define clear, measurable KPIs for the event's success."
    },
    {
      icon: Lightbulb,
      title: "Creative Concepting",
      description: "Our creative team develops a unique theme and visual language for the event that aligns with your brand. We present mood boards, venue options, and high-level structural concepts."
    },
    {
      icon: FileSignature,
      title: "Contracting & Budget Alignment",
      description: "Once the concept is approved, we secure the venue and essential vendors, locking in contracts and finalizing a strict budget to ensure no surprise costs arise during production."
    },
    {
      icon: HardHat,
      title: "Detailed Logistics Planning",
      description: "We build the master Run of Show. Every minute is accounted for. We handle travel manifests, dietary restrictions, floor plans, AV scripts, and health & safety compliance."
    },
    {
      icon: CalendarCheck,
      title: "On-Site Execution",
      description: "Our production team takes over the venue, managing load-in, tech rehearsals, and vendors. During the event, we run the floor so you can participate as a host rather than a stressed planner."
    },
    {
      icon: BarChart3,
      title: "Post-Event Reconciliation",
      description: "We manage the breakdown and strike. Afterward, we provide a comprehensive debrief, final budget reconciliation, and attendee feedback analysis to measure against our initial KPIs."
    }
  ];
      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-20">
          ...
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed max-w-lg mt-4">
            Flawless events are the result of rigorous, methodical planning. Here is how we take your event from a raw concept to a standing ovation.
          </p>
        </div>
