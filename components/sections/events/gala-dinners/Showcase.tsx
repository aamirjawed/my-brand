    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-[1400px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Left: Gala Moodboard / Plan Visual */}
            ...
            <div className="relative w-full max-w-[550px] aspect-square sm:aspect-[4/3] z-10 overflow-visible">
              ...
              >
                <div className="w-full h-full bg-slate-200 rounded overflow-hidden relative">
                  <img src="https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?q=80&w=600&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-80 mix-blend-multiply" alt="Banquet setup" />
                </div>
                <div className="absolute bottom-2 left-0 w-full text-center text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono">Ballroom View</div>
              </motion.div>
              ...
              >
                <div className="w-full h-full bg-slate-200 rounded overflow-hidden relative">
                  <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=600&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-80 mix-blend-multiply" alt="Award trophy" />
                </div>
                <div className="absolute bottom-2 left-0 w-full text-center text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono">Stage Award</div>
              </motion.div>
              ...
              >
                ...
                <h3 className="font-extrabold text-sm uppercase tracking-widest text-slate-900 mb-3 border-b-2 border-orange-600 pb-1 inline-block">Gala Program</h3>
                
                <div className="w-full space-y-3 mt-2">
                  {[
                    { time: "06:30 PM", desc: "Red Carpet Reception" },
                    { time: "07:30 PM", desc: "Grand Ballroom Opening" },
                    { time: "08:00 PM", desc: "Gourmet Banquet Served" },
                    { time: "09:30 PM", desc: "Charity Auction & Keynote" },
                    { time: "10:30 PM", desc: "Award Ceremonies & DJ" },
                  ].map((item, i) => (
          ...
          <div className="col-span-1 lg:col-span-6 flex flex-col justify-center">
            ...
            >
              <p className="text-base sm:text-lg leading-relaxed font-medium">
                Gala dinners are prestigious occasions where precision and luxury are paramount. A single oversight in layout, catering, or stage production can disrupt the entire experience. With our <strong className="text-orange-600 font-extrabold">specialist hospitality team</strong>, everything is executed flawlessly.
              </p>

              <p className="text-sm sm:text-base leading-relaxed">
                We handle the end-to-end management of luxury gala events. From meticulous venue selection and stunning tabletop design to gourmet catering reviews and live entertainment coordination. We oversee every logistical detail behind the scenes to deliver a seamless and memorable evening for your guests.
              </p>
              ...
              <p className="text-slate-700 text-xs sm:text-sm font-semibold italic border-l-2 border-orange-500 pl-4 bg-orange-50/50 py-2 pr-2">
                Whether you're raising funds for a global charity or celebrating corporate milestones with top executives, we bring refined hospitality and world-class production value to your gala.
              </p>
            </motion.div>
          </div>
