...
export default function Stats() {
  const stats = [
    { value: 300, suffix: "+", label: "Award Galas Produced", caption: "elegant evenings executed worldwide" },
    { value: 120, suffix: "k+", label: "Seated Guests Hosted", caption: "delivering refined table services" },
    { value: 45, suffix: "M+", label: "Charitable Funds Raised", caption: "through live auctions and pledges" },
    { value: 100, suffix: "%", label: "Hospitality Satisfaction", caption: "highly rated catering and design" },
  ];
      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        <div className="flex items-center justify-center mb-14">
          <div className="flex items-center gap-3">
            ...
            <span className="text-orange-500 font-extrabold text-xs tracking-[0.3em] uppercase">Gala Track Record</span>
            <div className="h-px w-12 bg-orange-600"></div>
          </div>
        </div>
