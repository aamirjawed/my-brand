...
export default function Stats() {
  const stats = [
    { value: 150, suffix: "+", label: "Media Syndicates Secure", caption: "guaranteed press placements on reveal day" },
    { value: 20, suffix: "M+", label: "Livestream Viewers Reached", caption: "across multi-platform broadcast feeds" },
    { value: 99.9, suffix: "%", label: "Staging System Reliability", caption: "dual-redundant audio, video and power" },
    { value: 100, suffix: "%", label: "Embargo Compliance", caption: "NDA management with zero leaked specs" },
  ];
      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        <div className="flex items-center justify-center mb-14">
          <div className="flex items-center gap-3">
            ...
            <span className="text-orange-500 font-extrabold text-xs tracking-[0.3em] uppercase">Launch Performance</span>
            <div className="h-px w-12 bg-orange-600"></div>
          </div>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-slate-800">
          {stats.map((stat, idx) => (
            ...
            >
              ...
              <div className="text-xs text-slate-500 leading-snug max-w-[150px]">{stat.caption}</div>
            </motion.div>
          ))}
        </div>
      </div>
