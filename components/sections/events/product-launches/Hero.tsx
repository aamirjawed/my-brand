        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl mx-auto mb-10 font-medium">
              We engineer hyper-immersive product launch events that convert passive audiences into passionate advocates. Combining high-end staging, cinematic visuals, and live interactive technology, we make sure your product commands the spotlight.
            </p>
          </motion.div>
        </div>
      </div>
