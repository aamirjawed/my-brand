...
import { FileText, Users, Calendar, MapPin, Activity, Trophy } from "lucide-react";
  ...
  const steps = [
    {
      ...
      description: "Defining tournament formats, official rulesets, scheduling regulations, and target team capacities."
    },
    {
      icon: Users,
      title: "Team Registration Setup",
      description: "Launching custom online portals for team entries, captain briefings, and player roster verifications."
    },
    {
      icon: Calendar,
      title: "Match Scheduling",
      description: "Generating algorithmically optimized match grids and brackets to prevent game delays and coordinate timings."
    },
    {
      icon: MapPin,
      title: "Venue & Operations Coordination",
      description: "Preparing fields/courts, staging scoreboard interfaces, and booking certified match officials."
    },
    {
      icon: Activity,
      title: "Real-Time Event Management",
      description: "Managing on-site match logistics, coordinating referee calls, and updating scores on the fly."
    },
    {
      icon: Trophy,
      title: "Results & Leaderboard Management",
      description: "Calculating final division standings, crowning champions, and displaying season stats online."
    }
  ];

  return (
    <section className="py-24 bg-slate-900 text-white relative overflow-hidden border-t border-b border-slate-950">
      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-wide">
            Our League Management Process
          </h2>
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed max-w-lg mt-4">
            From establishing rulesets to streaming the final match, we handle every detail with absolute operational precision.
          </p>
        </div>
