    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-[1400px]">
        ...
        <div className="w-full mb-16 border-l-4 border-orange-600 pl-4 sm:pl-6">
          ...
          >
            COMPETITIVE INTEGRITY, ELITE SCOREBOARD APIs, AND EXPERT OPERATIONS
          </motion.h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">

          {/* Left Column: Visual Moodboard & Checklist Clipboard */}
          <div className="col-span-1 lg:col-span-6 relative flex items-center justify-center min-h-[400px] sm:min-h-[500px]">
            ...
            <div className="relative w-full max-w-[550px] aspect-square sm:aspect-[4/3] z-10 overflow-visible">
              ...
              {/* Back Polaroid 1 (Esports Stadium) */}
              <motion.div
              ...
              >
                <div className="w-full h-full bg-slate-200 rounded overflow-hidden relative">
                  <img 
                    ...
                    alt="Esports Stadium Stage" 
                  />
                </div>
                <div className="absolute bottom-2 left-0 w-full text-center text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono">Stage Setup</div>
              </motion.div>

              {/* Back Polaroid 2 (Athletic Track) */}
              <motion.div
                initial={{ opacity: 0, x: 40, y: -20, rotate: 10 }}
              ...
              >
                <div className="w-full h-full bg-slate-200 rounded overflow-hidden relative">
                  <img 
                    ...
                    className="w-full h-full object-cover grayscale opacity-80 mix-blend-multiply" 
                    alt="Athletic Track Start" 
                  />
                </div>
                <div className="absolute bottom-2 left-0 w-full text-center text-[10px] font-bold text-slate-500 uppercase tracking-widest font-mono">Track Vetting</div>
              </motion.div>

              {/* Front Clipboard: Integrity Checklist */}
              <motion.div
              ...
              >
                ...
                <h3 className="font-extrabold text-sm uppercase tracking-widest text-slate-900 mb-3 border-b-2 border-orange-600 pb-1 inline-block">Integrity Checklist</h3>
                
                <div className="w-full space-y-3 mt-2">
                  {[
                    { task: "Bracket Seed Validation", metric: "Double-elim OK" },
                    { task: "Scoreboard API Latency", metric: "< 15ms verified" },
                    { task: "Official Accreditation", metric: "Certified crew" },
                    { task: "Rules Compliance Check", metric: "Completed" },
                    { task: "Player Portal Load Test", metric: "Passed 10K/s" },
                  ].map((item, i) => (
          ...
          <div className="col-span-1 lg:col-span-6 flex flex-col justify-center">
            ...
            >
              <p className="text-base sm:text-lg leading-relaxed font-medium">
                Designing a seamless tournament is the cornerstone of any professional event. A minor error in bracket seeding or a latency spike in live scoreboards can compromise competitive integrity. With our <strong className="text-orange-600 font-extrabold">sports tournament planning</strong> expertise, we align digital timing systems with elite rules administration and league event coordination.
              </p>

              <p className="text-sm sm:text-base leading-relaxed">
                We coordinate complete tournament infrastructure. From sports event planning and team coordination to managing complex competition management portals and hiring certified match officials, our league organization services cover every technical detail.
              </p>
              ...
              <p className="text-slate-700 text-xs sm:text-sm font-semibold italic border-l-2 border-orange-500 pl-4 bg-orange-50/50 py-2 pr-2">
                Whether you are hosting a local community cup, a corporate championship, or a stadium-level professional eSports event, our operational crew manages the entire program with absolute precision.
              </p>
            </motion.div>
          </div>
