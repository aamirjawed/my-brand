...
export default function FAQ() {
  ...
  const faqs = [
    {
      q: "What are league management services?",
      a: "League management services help organize tournaments and competitions including scheduling, team coordination, operations, and event execution."
    },
    {
      q: "Do you manage tournament scheduling?",
      a: "Yes, tournament scheduling and fixture coordination are included as part of league management services."
    },
    {
      q: "Can you handle team registrations?",
      a: "Absolutely. We launch customized digital portals for roster registration, team captain onboarding, waiver collection, and bracket check-ins to streamline registration before the games begin."
    },
    {
      q: "Do you provide venue coordination?",
      a: "Yes, we manage all venue setup aspects including court/field marking, scoreboard positioning, timing system configuration, spectator safety management, and referee operations."
    },
    {
      q: "Can you manage esports tournaments?",
      a: "Yes, we coordinate esports tournaments with custom gaming server settings, observer desks, broadcast casting integrations, and live stats API feeds for platforms like Twitch and YouTube."
    }
  ];
      ...
      <div className="container mx-auto px-6 max-w-[1000px] relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16">
          ...
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed max-w-md mt-2">
            Find answers on rulebooks, scoring integrations, game administration, and outage contingencies.
          </p>
        </div>
