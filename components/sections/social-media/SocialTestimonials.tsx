...
const testimonials = [
  {
    ...
    company: "CoreFintech",
    metric: "+240% Inbound Lead Lift",
    quote: "Their content planning and Instagram campaign setup transformed our social accounts. By establishing a clear brand consistency, they boosted our direct inquiries.",
  ...
  },
  {
    ...
    quote: "We needed a creative team focused on Reels and video curation. Their short video editing and script hooks doubled our follower count in under 60 days.",
    avatarColor: "bg-[#a7f3d0]",
    textColor: "text-emerald-950",
    tag: "REELS PREVIEWS & VIDEO"
  },
  {
    name: "Vikram Oberoi",
    role: "Partner",
    company: "Capital Ventures",
    metric: "Saved 20+ Hours/Wk",
    quote: "Our team was struggling to keep our social channels updated consistently. Their scheduled planners and report dashboards saved us countless hours of internal overhead.",
    avatarColor: "bg-[#bfdbfe]",
    textColor: "text-blue-950",
    tag: "CONTENT PLANNER OUTSOURCE"
  }
];
...
export default function SocialTestimonials() {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden border-t border-slate-100">
      {/* Background blobs */}
      <div className="absolute top-1/4 left-0 w-80 h-80 bg-orange-100/40 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-[#fed7aa]/20 rounded-full blur-[120px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">

        {/* Section Header */}
        <div className="flex flex-col items-start text-left mb-8 sm:mb-10">
          <h4 className="text-orange-650 font-bold tracking-widest text-xs sm:text-sm mb-4 uppercase">
            Client Stories
          </h4>
          <h2
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center text-left">
            ...
            <p className="text-slate-650 text-lg mb-8 leading-relaxed font-medium">
              We count business milestones, optimized visual reaches, and scaled brand operations. Swipe through to view real statistics.
            </p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-slate-500 text-xs font-bold uppercase tracking-wider">
                        {activeTestimonial.role} at <span className="text-orange-650 font-extrabold">{activeTestimonial.company}</span>
                      </p>
                    </div>
                  </div>
                </motion.div>
