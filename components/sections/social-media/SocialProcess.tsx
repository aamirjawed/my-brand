...
import { Search, Compass, Paintbrush, CalendarClock, MessageSquare, TrendingUp } from "lucide-react";
  ...
  const steps = [
    {
      ...
      description: "We audit your brand style guidelines, analyze competitor posting strategies, and define target customer demographics."
    },
    {
      icon: Compass,
      title: "Content Planning",
      description: "We map out content pillars, design feed drafts, and build custom bi-weekly content calendars for approval."
    },
    {
      icon: Paintbrush,
      title: "Design & Content Creation",
      description: "Our graphics team designs post assets, writes headlines, crafts custom reels scripts, and compiles hashtag blocks."
    },
    {
      icon: CalendarClock,
      title: "Post Scheduling",
      description: "We schedule approved posts across all active platforms during optimal viewport hours to secure peak reach."
    },
    {
      icon: MessageSquare,
      title: "Engagement & Monitoring",
      description: "We respond to comment queries, flag direct messages, trigger interactive story polls, and build community lines."
    },
    {
      icon: TrendingUp,
      title: "Analytics & Optimization",
      description: "We review bi-weekly metrics reports, adjust content tags, audit reach drops, and optimize planning pillars."
    }
  ];

  return (
    <section className="py-24 bg-slate-905 text-white relative overflow-hidden">
      {/* Background patterns */}
      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-20">
          ...
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed max-w-lg mt-4 font-medium">
            A methodical approach ensuring your profiles are updated consistently, design assets look professional, and leads scale up monthly.
          </p>
        </div>
