...
const testimonials = [
  {
    ...
    quote: "Their UI/UX team transformed our legacy portal into an intuitive visual masterpiece. By establishing a robust design system, they boosted user engagement and reduced user friction.",
  ...
  },
  {
    ...
    quote: "We needed a mobile banking interface focused on interaction design. Their layout prototype and responsiveness testing helped us double customer onboarding within 30 days.",
    avatarColor: "bg-[#a7f3d0]",
    textColor: "text-emerald-950",
    tag: "MOBILE INTERACTION DESIGN"
  },
  {
    name: "Rohan Khanna",
    role: "VP of Product",
    ...
    quote: "Our team was struggling to code layouts. Their modular UI/UX variables and custom Figma libraries saved our engineering team dozens of hours every week.",
...
export default function UiUxTestimonials() {
