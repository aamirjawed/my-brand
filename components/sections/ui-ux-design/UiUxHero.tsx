...
export default function UiUxHero() {
  const benefits = ["User Experience", "Interface Quality", "Conversions", "Branding", "Usability", "Modern Aesthetics"];
    ...
    <section className="relative h-auto pt-44 pb-28 sm:py-36 md:py-40 flex flex-col overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          alt="Modern UI/UX Design Interface Studio"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl mx-auto mb-10">
              We create intuitive, responsive, and visually engaging UI/UX designs that improve usability, customer engagement, and digital experiences.
            </p>
          </motion.div>
        </div>
      </div>
