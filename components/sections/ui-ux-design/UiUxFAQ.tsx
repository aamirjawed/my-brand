...
interface UiUxFAQProps {
  faqs: FAQItem[];
}

export default function UiUxFAQ({ faqs }: UiUxFAQProps) {
      ...
      <div className="container mx-auto px-6 max-w-[1000px] relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16">
          ...
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed max-w-md mt-2 font-medium">
            Learn more about how user experience design, responsive interfaces, and interaction design build brand trust.
          </p>
        </div>
