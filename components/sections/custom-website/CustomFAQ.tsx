...
export default function CustomFAQ({ faqs }: CustomFAQProps) {
      ...
      <div className="container mx-auto px-6 max-w-[1000px] relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-900 text-white text-xs font-bold uppercase tracking-widest mb-4">
            <HelpCircle className="w-3.5 h-3.5 text-orange-500" /> Have Questions?
          </div>
          ...
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed max-w-md mt-2">
            Learn more about how custom web development builds trust, scales features, and increases online search rankings.
          </p>
        </div>
