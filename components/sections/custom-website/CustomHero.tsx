...
export default function CustomHero() {
  const customBenefits = ["Business Growth", "Brand Credibility", "Online Presence", "Scalability", "User Experience"];
    ...
    <section className="relative h-auto pt-44 pb-28 sm:py-36 md:py-40 flex flex-col overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          alt="Custom Website Development Infrastructure"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl mx-auto mb-10">
              We design and develop fast, modern, and scalable custom websites optimized for branding, performance, and long-term business growth.
            </p>
          </motion.div>
        </div>
      </div>
